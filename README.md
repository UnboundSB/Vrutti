...
| | Installer | Portable |
|---|:---:|:---:|
| **File** | `Vrutti_Alpha_0.0.3_SleepyRabbit_Setup.exe` | `vrutti_early_release.zip` |
...
| **Get it** | [Download →](https://github.com/UnboundSB/Vrutti/releases/latest/download/Vrutti_Alpha_0.0.3_SleepyRabbit_Setup.exe) | [Download →](https://github.com/UnboundSB/Vrutti/releases/latest/download/vrutti_early_release.zip) |
...
4. `.\build_installer.ps1` → `Vrutti_Alpha_0.0.3_SleepyRabbit_Setup.exe`
